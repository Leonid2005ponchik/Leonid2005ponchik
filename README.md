...
Мне нравится находить скрытые закономерности в данных и превращать их в реальную пользу. Математика — это не просто теория, а инструмент, который я понимаю и применяю. Особенно интересны задачи прогнозирования (временные ряды, предсказание продаж) и анализ физических процессов (например, анализ энергоресурсов).
...
- Парсер собирает вакансии с hh.ru (пагинация, конвертация валют) → 18 000+ вакансий, 17 профессий
...
**Energy Data** — анализ количества энергоресурсов. В проекте построена ML-модель, создан дашборд с графиками, организовано обращение к SQL-базе данных.

**Duckerz** — решение задач по криптографии, форензике, вебу, стеганографии.
...
- Обыкновенные дифференциальные уравнения (до второго порядка: метод Пикара, задача Коши, уравнение Вольтерра)
